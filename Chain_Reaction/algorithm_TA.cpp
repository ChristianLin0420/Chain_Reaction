...
TreeNode* gameTree::chooseOrb(int difficulty){
    ...
    for(;firstLevelNode==NULL;firstLevelNode=firstLevelNode->getNextNode()){
        ...
        for(;secondLevelNode==NULL;secondLevelNode=secondLevelNode->getNextNode()){
            ...
            for(;thirdLevelNode==NULL;thirdLevelNode=thirdLevelNode->getNextNode()){
                ...
                for(;fourthLevelNode==NULL;fourthLevelNode=fourthLevelNode->getNextNode()){
